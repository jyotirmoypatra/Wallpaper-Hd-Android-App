...
public class adapterWallpaper extends RecyclerView.Adapter<WallpaperViewHolder> {
    private Context context;
    private List<WallpaperModel> wallpaperModelList;

    public adapterWallpaper(Context context, List<WallpaperModel> wallpaperModelList) {
